<div class="container">
    ...
    <h2 class="d-flex justify-content-center">Modifier Produit : <?= $idArticles->getNom() ?> </h2>

    <!-- enctype si un fichier est envoyer avec le formulaire -->

    <form novalidate action="./?path=admin&action=traitementFormModifArcticle&idArticle=<?=$theid?>" class="col-lg-6  col-md-8 mx-auto " enctype="multipart/form-data" method="post">
