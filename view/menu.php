  ...
  <nav class="navbar navbar-expand-lg menu-nav">
    <div class="container-fluid justify-content-around">
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <span class="navbar-toggler-icon"><svg xmlns="http://www.w3.org/2000/svg" class="hsvg" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
          ...
          <div class="d-flex me-5">
            ...
            <?php if (isset($lesCategories)) : ?>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown" id="deroulant">
      ...
      <div class="d-flex">
        ...
        <?php if (isset($_SESSION['role'])) : ?>
          ...
          <?php if ($_SESSION[('role')] == 'client') : ?>
            ...
            <li class="nav-item">
              <a class="nav-link" href="./?path=client&action=panier">
